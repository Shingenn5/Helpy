...
- **Custom Skills**: Filesystem-based (`.helpy/skills/` or
  `~/.helpy/skills/`)
- **Sharing**: Via git/version control
- **Integration**: Skills are activated through the agent's skill activation system

**Note**: Skills are specific to Helpy's implementation and work through the built-in skill management system.
