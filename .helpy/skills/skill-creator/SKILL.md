...
name: skill-creator
# prettier-ignore
description: Create Helpy Agent Skills by writing SKILL.md files, defining frontmatter metadata, structuring references, and organizing skill directories. Use when building a new skill, creating a SKILL.md, planning skill architecture, or writing skill content.
---
...
1. Create skill directory: `.helpy/skills/my-skill/`
...
---
name: deploy-helper
description: Deploy Helpy builds to staging and production environments. Use when deploying, releasing, or publishing builds.
---
```
...
Build and deploy Helpy to target environments.
