...
Helpy provides pre-configured mocks for Electron and internal APIs.
...
Helpy provides centralized mock factories for consistent testing across the codebase.
