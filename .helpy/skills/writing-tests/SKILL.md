---
name: writing-tests
description: Write unit tests, component tests, and integration tests for Helpy using Vitest and React Testing Library. Use when creating new tests, adding test coverage, configuring mocks, setting up test files, or debugging failing tests.
---
