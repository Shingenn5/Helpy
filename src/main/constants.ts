...
export const AIDER_DESK_TITLE = 'Helpy';
export const AIDER_DESK_WEBSITE = 'https://github.com/Shingenn5/Helpy';
...
export const DB_FILE_PATH = path.join(AIDER_DESK_DATA_DIR, 'helpy.db');
...
export const SERVER_PORT = process.env.HELPY_PORT
  ? parseInt(process.env.HELPY_PORT)
  : process.env.AIDER_DESK_PORT
