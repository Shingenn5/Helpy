...
vi.mock('@/constants', () => ({
  ...
  AIDER_DESK_TASKS_DIR: '.helpy/tasks',
  AIDER_DESK_DIR: '.helpy',
  AIDER_DESK_TODOS_FILE: 'todos.json',
  AIDER_DESK_RULES_DIR: 'rules',
  AIDER_DESK_PROJECT_RULES_DIR: '.helpy/rules',
  AIDER_DESK_GLOBAL_RULES_DIR: '/home/.helpy/rules',
  AIDER_DESK_COMMANDS_DIR: '.helpy/commands',
  AIDER_DESK_PROMPTS_DIR: '.helpy/prompts',
  AIDER_DESK_DEFAULT_PROMPTS_DIR: '/resources/prompts',
  AIDER_DESK_GLOBAL_PROMPTS_DIR: '/home/.helpy/prompts',
  AIDER_DESK_AGENTS_DIR: '.helpy/agents',
  AIDER_DESK_TMP_DIR: '.helpy/tmp',
  AIDER_DESK_WATCH_FILES_LOCK: '.helpy/watch-files.lock',
  WORKTREE_BRANCH_PREFIX: 'helpy/task/',
