...
import { server } from '../helpy-mcp-server';

vi.mock('axios');

describe('Helpy MCP Server', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('should be initialized with correct metadata', () => {
    ...
    expect(serverInfo.name).toBe('helpy-mcp-server');
  ...
  it('should call Helpy API when add_context_file is executed', async () => {
  ...
  it('should call Helpy API when drop_context_file is executed', async () => {
    const mockResponse = { data: { success: true } };
    vi.mocked(axios.post).mockResolvedValueOnce(mockResponse);
  ...
  it('should call Helpy API when get_context_files is executed', async () => {
  ...
  it('should call Helpy API when get_addable_files is executed', async () => {
  ...
  it('should call Helpy API when run_prompt is executed', async () => {
  ...
  it('should call Helpy API when clear_context is executed', async () => {
    const mockResponse = { data: { success: true } };
    vi.mocked(axios.post).mockResolvedValueOnce(mockResponse);
