...
const api: ApplicationAPI = {
  ...
  getHelpyBackendLogs: () => ipcRenderer.invoke('helpy-backend-logs'),
  checkHelpyBackendHealth: () => ipcRenderer.invoke('helpy-backend-health'),
  getHelpyOpenClawConfig: () => ipcRenderer.invoke('helpy-openclaw-config'),
  configureHelpyOpenClaw: (config) => ipcRenderer.invoke('helpy-openclaw-configure', config),
  startHelpyOpenClaw: () => ipcRenderer.invoke('helpy-openclaw-start'),
  stopHelpyOpenClaw: () => ipcRenderer.invoke('helpy-openclaw-stop'),
  getHelpyOpenClawStatus: () => ipcRenderer.invoke('helpy-openclaw-status'),
  getHelpyOpenClawLogs: () => ipcRenderer.invoke('helpy-openclaw-logs'),
  getHelpyVoiceConfig: () => ipcRenderer.invoke('helpy-voice-config'),
  configureHelpyVoice: (config) => ipcRenderer.invoke('helpy-voice-configure', config),
  getHelpyVoiceStatus: () => ipcRenderer.invoke('helpy-voice-status'),
  startHelpyPushToTalk: () => ipcRenderer.invoke('helpy-voice-push-to-talk'),
  getHelpyMemoryGraphStats: () => ipcRenderer.invoke('helpy-memory-graph-stats'),
